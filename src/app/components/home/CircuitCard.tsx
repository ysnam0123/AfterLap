...
export function CircuitCard({ data, idx }: CircuitProps) {
  return (
    <div className="flex h-15 cursor-pointer items-center justify-between rounded-xl bg-(--color-card-bg) px-5 py-2.5 transition hover:bg-(--color-card-hover) sm:h-25">
